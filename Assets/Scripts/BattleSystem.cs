...
public class BattleSystem : MonoBehaviour
{
    ...
    public void SpawnEnemy(int elementalNum)
    {
        ...
        while (i < elementalNum)
        {
            ...
            {
                GameObject flameElementalGO = Instantiate(enemyPrefab, transform.position, Quaternion.Euler(0,0,0)) as GameObject;
    ...
    void CreateSpawner(int track)
    {
        if (createSpawner == 2)
        {
            Instantiate(enemySpawner3, new Vector3(440, 0, 834), Quaternion.Euler(0, 90, 0));
        }
        if (createSpawner == 3)
        {
