...
public class PlayerMovement : MonoBehaviour
{
	...
	void Update () {
		...
		if(destinationDistance < 2f || BattleSystem.state != BattleState.NOCOMBAT){		// To prevent shakin behavior when near destination
			moveSpeed = 0;
        }
        ...
        if (BattleSystem.state == BattleState.NOCOMBAT)
        {
